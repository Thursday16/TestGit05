...
Suppose you calculated a total digital time of 7:15, 7 hours and 15 minutes. The equivalent time in decimal hours is 7.25 hours.  You will need decimal hours to calculate pay.

Converting from minutes to decimal hours

7:15 is 7.0 hours plus 15 minutes.  You'll need to convert the minutes part to hours.

15 minutes times 1 hour per 60 minutes will make the conversion to hours and minutes will cancel out.

15 min × (1 hr / 60 min) = (15/60) hr = 0.25 hr

Adding the 0.25 to the 7.0 our total is 7.0 + 0.25 = 7.25 hours

In Reverse, converting from decimal hours to minutes

0.25 hours times 60 minutes per 1 hour = 0.25 hr × (60 min/ 1hr) = (0.25 × 60) min = 15 minutes.'''
